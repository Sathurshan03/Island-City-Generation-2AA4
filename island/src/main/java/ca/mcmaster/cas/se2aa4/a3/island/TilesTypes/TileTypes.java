...
public enum TileTypes {
    ...
    LAKE(new Color(15,94,196, 254), TileElement.WATER),
    GRASSLAND(new Color(0,153,0,254), TileElement.LAND),
    ENDORHEICLAKE(new Color(15,94,196,254), TileElement.WATER),
    ICE(new Color(192,200,255,254), TileElement.LAND),
    SNOW(new Color(255,250,251,254), TileElement.LAND),
    TAIGA(new Color(0,110,0,254), TileElement.LAND),
    TUNDRA(new Color(140,151,133,254), TileElement.LAND);
