...
public class Volcanic implements LandAltitude{
    ...
    public AltitudeFunction function= (x,y)->{return 100.0*(Mode.getWidth()/10)/((Mode.getWidth()/500000)*Math.pow((x-Mode.getWidth()/2),2)+(Mode.getWidth()/500000)*Math.pow(y-Mode.getHeight()/2,2)+1);};
