...
public class CustomPolygon{
    ...
    public CustomPolygon(int centroid, int squareSize){
        ...
        this.centroid=gen_poly.centroid;
        this.centroid_idx=centroid;

        this.neighbours=gen_poly.neighbours;

        this.poly_vertices=gen_poly.poly_vertices;

        this.poly_segment=gen_poly.poly_segment;

        this.segment_index=gen_poly.segment_index;
